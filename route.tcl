...
#
#
write_verilog ./results/shifter_8bit.routed.v
write_sdc -output ./results/shifter_8bit.routed.sdc
write_parasitics -format spef -output ./results/shifter_8bit_${scenario1}.spef
#
